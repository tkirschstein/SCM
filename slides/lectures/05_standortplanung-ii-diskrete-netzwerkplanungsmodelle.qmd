...
digraph wlp {
  ...
  /* ---- Rang ---- */
  { rank = same; W1; W2; W3 }
  { rank = same; CA; CB; CC; CD }

  /* ---- Kanten mit Beschriftungen ---- */
  edge [
    color = '#4B4B4B',
    penwidth = 1.4,
    arrowsize = 0.9,
  ...
  /* ---- externe Labels für f_i und d_j ---- */
  /* Einrichtungskosten links von den Lagern */
  node [
    shape = none,
    style = none,
  ...
  /* unsichtbare Kanten für Positionierung */
  ...
  { rank = same; LF1; LF2; LF3; W1; W2; W3 }
  { rank = same; CA; CB; CC; CD; LD_A; LD_D; LD_mid }
  { rank = min;  LSetI }
  { rank = max;  LSetJ }
}
")
