...
::: {style="background:#F0F0F0; padding:10px 16px; font-size:0.82em; line-height:1.5; border:1px solid #ccc; margin-bottom:8px;"}
Der 3PL muss [entscheiden]{.underline}, [welche]{.underline} seiner [Lagerstandorte]{.underline} er [umrüstet]{.underline} und [welche]{.underline} Werke von [welchem Lager versorgt werden soll]{.underline}. Das [Unternehmen]{.underline} möchte die [Entscheidung]{.underline} so [treffen, dass die jährlichen Gesamtkosten für Lagerbetrieb]{.underline} und Transport [minimiert werden]{.underline}. [Folgende Informationen sind bekannt:]{.underline}
:::
...
df_dist <- cbind(`$d_{ij}$` = rownames(dist_mat),
                 as.data.frame(dist_mat))

kbl(df_dist,
    col.names = c("$d_{ij}$", paste0("C",1:11)),
    align = c("c", rep("r",11)),
    escape = FALSE) |>
  kable_styling(bootstrap_options = c("condensed","striped"),
...
kbl(werke,
    col.names = c("ID","Werksname","Ort",
                  "Längen-<br>grad","Breiten-<br>grad",
                  "Batteriebedarf<br>(MWh/Jahr)"),
    align = c("c","l","l","r","r","r"),
    escape = FALSE,
